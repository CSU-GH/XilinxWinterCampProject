...
module contrastadj_xfMat2AXIvideo_24_9_1080_1920_1_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
input  [23:0] img4_434_dout;
input   img4_434_empty_n;
output   img4_434_read;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln195_fu_155_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_condition_pp0_flush_enable)) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln195_fu_155_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln195_fu_155_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter1_state4) & (ap_enable_reg_pp0_iter0 == 1'b0)))) begin
            ap_enable_reg_pp0_iter1 <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln195_fu_155_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        j_reg_129 <= 11'd0;
    end else if (((icmp_ln197_fu_167_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((icmp_ln197_reg_194_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        sof_2_reg_140 <= 1'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln197_fu_167_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln197_fu_167_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln195_fu_155_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln197_reg_194_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if ((((icmp_ln197_reg_194_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0)) | ((icmp_ln197_reg_194 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if (((icmp_ln197_reg_194 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln197_reg_194 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln197_reg_194 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (img4_434_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state5_io)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln197_reg_194 == 1'd0) & (img4_434_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state5_io)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln197_reg_194 == 1'd0) & (img4_434_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state4_io = ((icmp_ln197_reg_194 == 1'd0) & (dst_axi_TREADY_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((icmp_ln197_reg_194 == 1'd0) & (img4_434_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state5_io = ((icmp_ln197_reg_194_pp0_iter1_reg == 1'd0) & (dst_axi_TREADY_int_regslice == 1'b0));
end
...
assign dst_axi_TVALID = regslice_both_AXI_video_strm_V_data_V_U_vld_out;

assign i_1_fu_161_p2 = (i_reg_104 + 11'd1);

assign icmp_ln195_fu_155_p2 = ((i_reg_104 == 11'd1080) ? 1'b1 : 1'b0);

assign icmp_ln197_fu_167_p2 = ((j_reg_129 == 11'd1920) ? 1'b1 : 1'b0);

assign j_1_fu_173_p2 = (j_reg_129 + 11'd1);

assign tmp_last_V_fu_179_p2 = ((j_reg_129 == 11'd1919) ? 1'b1 : 1'b0);

endmodule //contrastadj_xfMat2AXIvideo_24_9_1080_1920_1_s
