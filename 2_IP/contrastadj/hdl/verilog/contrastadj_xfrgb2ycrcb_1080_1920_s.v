...
output   ap_idle;
output   ap_ready;
input  [23:0] img1_431_dout;
input   img1_431_empty_n;
output   img1_431_read;
output  [23:0] img2_432_din;
input   img2_432_full_n;
output   img2_432_write;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln99_reg_408 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        B_assign_reg_427 <= {{img1_431_dout[23:16]}};
        G_assign_reg_422 <= {{img1_431_dout[15:8]}};
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln99_reg_408_pp0_iter8_reg == 1'd0) & (ap_enable_reg_pp0_iter9 == 1'b1) & (img2_432_full_n == 1'b0)) | ((icmp_ln99_reg_408 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (img1_431_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln99_reg_408_pp0_iter8_reg == 1'd0) & (ap_enable_reg_pp0_iter9 == 1'b1) & (img2_432_full_n == 1'b0)) | ((icmp_ln99_reg_408 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (img1_431_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln99_reg_408_pp0_iter8_reg == 1'd0) & (ap_enable_reg_pp0_iter9 == 1'b1) & (img2_432_full_n == 1'b0)) | ((icmp_ln99_reg_408 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (img1_431_empty_n == 1'b0)));
end
...
always @ (*) begin
    ap_block_state11_pp0_stage0_iter9 = ((icmp_ln99_reg_408_pp0_iter8_reg == 1'd0) & (img2_432_full_n == 1'b0));
end

assign ap_block_state2_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = ((icmp_ln99_reg_408 == 1'd0) & (img1_431_empty_n == 1'b0));
end
...
assign img2_432_din = {{{Value_uchar_12_fu_350_p3}, {Value_uchar_11_fu_270_p3}}, {Value_uchar_10_reg_458_pp0_iter8_reg}};
...
assign trunc_ln674_fu_122_p1 = img1_431_dout[7:0];
