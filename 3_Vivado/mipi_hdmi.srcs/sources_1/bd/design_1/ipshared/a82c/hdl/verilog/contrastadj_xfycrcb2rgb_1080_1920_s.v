...
output   start_out;
output   start_write;
input  [23:0] img3_433_dout;
input   img3_433_empty_n;
output   img3_433_read;
output  [23:0] img4_434_din;
input   img4_434_full_n;
output   img4_434_write;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln124_reg_447_pp0_iter3_reg == 1'd0) & (ap_enable_reg_pp0_iter4 == 1'b1) & (img4_434_full_n == 1'b0)) | ((icmp_ln124_reg_447 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (img3_433_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln124_reg_447_pp0_iter3_reg == 1'd0) & (ap_enable_reg_pp0_iter4 == 1'b1) & (img4_434_full_n == 1'b0)) | ((icmp_ln124_reg_447 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (img3_433_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln124_reg_447_pp0_iter3_reg == 1'd0) & (ap_enable_reg_pp0_iter4 == 1'b1) & (img4_434_full_n == 1'b0)) | ((icmp_ln124_reg_447 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (img3_433_empty_n == 1'b0)));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = ((icmp_ln124_reg_447 == 1'd0) & (img3_433_empty_n == 1'b0));
end
...
always @ (*) begin
    ap_block_state6_pp0_stage0_iter4 = ((icmp_ln124_reg_447_pp0_iter3_reg == 1'd0) & (img4_434_full_n == 1'b0));
end
...
assign cb_assign_fu_134_p4 = {{img3_433_dout[23:16]}};

assign cr_assign_fu_124_p4 = {{img3_433_dout[15:8]}};
...
assign img4_434_din = {{{Value_uchar_5_fu_398_p3}, {select_ln995_fu_319_p3}}, {Value_uchar_4_fu_246_p3}};
...
assign trunc_ln674_fu_120_p1 = img3_433_dout[7:0];
