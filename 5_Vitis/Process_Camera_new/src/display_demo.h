...
#if P1080 == 1
#define DEMO_MAX_FRAME (1920*1080*3) //(1920*1080*3)
#define DEMO_STRIDE (1920 * 3)  //(1920 * 3)
#else
#define DEMO_MAX_FRAME (1280*720*3) //(1280*720*3)
#define DEMO_STRIDE (1280 * 3) //(1280 * 3)
#endif
